...
# checkpoints_dir = r'E:\python program\checkpoint_6k'
# log_folder = r'E:\python program\log_folder'

checkpoints_dir = '/home/gpudouble1/zhangchao/fcn/checkpoint_2w_32s'
log_folder = '/home/gpudouble1/zhangchao/fcn/log_folder'


slim = tf.contrib.slim
fcn_32s_checkpoint_path = os.path.join(checkpoints_dir, 'fcn32s_15e.ckpt')
...
with tf.Session() as sess:
    ...
    for i in range(25004 * 15):
        ...
        '''
        if i % 25004 == 0:
            # save_path = saver.save(sess, r"E:\python program\checkpoint_test\fcn16s_10e.ckpt")
            save_path = saver.save(sess, "/home/gpudouble1/zhangchao/fcn/checkpoint/fcn16s_15e.ckpt")
...
loss_all = open('loss_file_16s.txt', 'w')
