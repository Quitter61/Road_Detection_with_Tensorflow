...
checkpoints_dir = '/home/damon/PycharmProjects/python/second_dataset/16s/fcn32s'
log_folder = '/home/damon/PycharmProjects/python/second_dataset/16s/log_folder'

slim = tf.contrib.slim
fcn_32s_checkpoint_path = os.path.join(checkpoints_dir, 'fcn32s_model10e_2.ckpt')
...
with tf.variable_scope("fcn_16s")  as fcn_16s_scope:
    ...
    fused_last_layer_and_pool4_upsampled_16s_logits_shape = tf.pack([fused_last_layer_and_pool4_logits_shape[0],
...
flat_logits = tf.reshape(tensor=fused_last_layer_and_pool4_upsampled_by_factor_16s_logits,
...
with tf.Session() as sess:
    ...
    for i in range(529 * 10):
        ...
        '''
        if i % 529 == 0:
            save_path = saver.save(sess, "/home/damon/PycharmProjects/python/second_dataset/16s/checkpoint/fcn16s_model10e_2.ckpt")
